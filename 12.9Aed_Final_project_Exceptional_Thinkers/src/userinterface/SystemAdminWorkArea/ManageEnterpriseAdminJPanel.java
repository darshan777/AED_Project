...
import Business.Role.CompanyAdmin;
import Business.Role.CompanyManagerRole;
import Business.Role.StudentRole;
import Business.Role.UniversityAdmin;
...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Manage Enterprise Credentials");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(105, 364, Short.MAX_VALUE)
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        String manufacturingYear = nameJTextField.getText();
        Matcher m = pattern.matcher(manufacturingYear);
        ...
        UserAccount account = null;
         if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.Company) {
                account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new CompanyAdmin());
            }
         else if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.University){
         account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new UniversityAdmin());
